...
def kalman_filter(z_meas, x_esti, P, Q):
    # 1. Prediction
    x_pred = A @ x_esti
    P_pred = A @ P @ A.T + Q
...
for i in range(n_samples):
    ...
    if i == 0:
        ...
        x_esti, P = kalman_filter(z_meas, x_esti, P, Q)
        x_100_esti, P_100 = kalman_filter(z_meas, x_100_esti, P, Q_100)
...
plt.scatter(xpos_100_esti_save, ypos_100_esti_save, s=300, c="r", marker='*', label='1/100 Q')
...
plt.xlim((-10, 350))
plt.ylim((250, -10))
plt.savefig('png/object_tracking_Q_value.png')